...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var elementos = document.querySelectorAll('.mi-elemento');
    var mostrarBoton = document.getElementById('mostrarBoton');
  
    // Programa una función para mostrar los elementos al hacer clic en el botón
    mostrarBoton.addEventListener('click', function() {
      elementos.forEach(function(elemento) {
        elemento.style.display = 'block'; // Muestra los elementos cambiando 'none' a 'block'
      });
    });
  });